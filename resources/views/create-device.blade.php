                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('create.device') }}">
                                ...
                                <div class="form-group{{ $errors->has('unique_id') ? ' has-error' : '' }}">
                                    <label for="unique_id" class="col-md-4 control-label">UniqueID(MAC Address preferred):</label>

                                    <div class="col-md-6">
                                        <input id="unique_id" type="text" class="form-control" name="unique_id">
                                        ...
                                        @else
                                            <span class="help-block">
                                                <strong> Will be generated if left blank</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
