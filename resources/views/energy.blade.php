          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">IoT Dashboard</span>
                <h3 class="page-title">IoT Data Overview</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Small Stats Blocks -->
              ...
              <div class="col-lg col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    ...
                    <canvas height="196" class="blog-overview-stats-small-4 chartjs-render-monitor" width="492" style="display: block; height: 98px; width: 246px;"></canvas>
                  </div>
                </div>
              </div>
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    ...
                    <canvas height="196" class="blog-overview-stats-small-1 chartjs-render-monitor" width="492" style="display: block; height: 98px; width: 246px;"></canvas>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg col-md-4 col-sm-12 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    ...
                    <canvas height="196" class="blog-overview-stats-small-5 chartjs-render-monitor" width="492" style="display: block; height: 98px; width: 246px;"></canvas>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    ...
                    <canvas height="196" class="blog-overview-stats-small-3 chartjs-render-monitor" width="492" style="display: block; height: 98px; width: 246px;"></canvas>
                  </div>
                </div>
              </div>
            </div>
                ...
                {{--<div class="card-body p-0 d-flex"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>--}}
                  {{--<div class="d-flex flex-column m-auto">--}}
                    {{--<div class="stats-small__data text-center">--}}
                      ...
                      {{--<h6 id="valTemperature" class="stats-small__value count my-3">{{ $value->temperature }}</h6>--}}
                    {{--</div>--}}
                    {{--<div class="stats-small__data">--}}
                      {{--<!-- <span class="stats-small__percentage stats-small__percentage--increase">12.4%</span> -->--}}
                    {{--</div>--}}
                  {{--</div>--}}
                  {{--<canvas height="196" class="blog-overview-stats-small-2 chartjs-render-monitor" width="492" style="display: block; height: 98px; width: 246px;"></canvas>--}}
                {{--</div>--}}
              {{--</div>--}}
            {{--</div>--}}
...
<div class="col-lg-8 mb-4">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Device Control</h6>
                  </div>
...
{{--                                @if($value->state === "on")--}}
                                ...
                                {{--</button>--}}
                                {{--@endif--}}
                              {{--<label class="custom-control-label" id="br" for="customToggle1">Turn Device On / Off</label>--}}
                            </div>
                            <!-- <div class="custom-control custom-toggle custom-toggle-sm mb-1">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            let socket = io('http://0.0.0.0:2021');
            socket.on('data.updated', function (response) {
                response = JSON.parse(response);
                $('#valVoltage').html(response.volatge);
                $('#valCurrent').html(response.current);
                $('#valPower').html(response.power);
                $('#valEnergy').html(response.energy);
                $('#valTemperature').html(response.temperature);
            });
            ...
            $("#stateButton").click(function (e) {
                ...
                $.post('/sensor/update', { state : state, _token : window.csrfToken }, function (response) {
                    let stateButton = $("#stateButton");
                    let butSate = stateButton.attr('data-state');
                    let newState = "off";
                    if (butSate === "off") {
                        newState = "on";
                        stateButton.removeClass('btn-danger').addClass('btn-success');
                        stateButton.html("Turn On");
                    } else {
                        stateButton.removeClass('btn-success').addClass('btn-danger');
                        stateButton.html("Turn Off");
                    }

                    stateButton.attr('data-state', newState);
                });
            });
            // button.change(function () {
            //     let butState = $(this).val();
            //
            //     // console.log(butState);
            //     //
            //     // if (butState === 'on') { finalState = 'off'; }
            //     // else if (butState === 'off') { finalState = 'on'; }
            //     // else {
            //     //   finalState = 'off';
            //     // }
            //
            ...
            window.setInterval(function() {
                $.get('/sensor/value', function(response) {
                  ...
                  var state = response.state === 'on' ? 'selected' : '';

                  $("#customToggle1").prop({checked : response.state === 'on' });
                });
            }, 1000)
        });
